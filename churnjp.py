...
selected_analysis = st.sidebar.selectbox('Choose Analysis', ['Churn Analysis','RFM Analysis','Sales Performance Evaluation','Segmentation & Category Sold'])
...
elif selected_analysis == 'Segmentation & Category Sold':
    import warnings
    warnings.filterwarnings('ignore')
    import streamlit as st
    import pandas as pd
